...
function TarjetaModal(props) {
  // Tarjeta con la info de un punto seleccionado en el mapa
  ...
  return (
    <div className="tarjeta_modal_conteiner">
      <div className="tarjeta_modal_title">
        ...
        <div
          className="tarjeta_modal_config"
          onClick={
            tipo === "tanque" ? changeMostrarTanque : changeMostrarPerfAuto
          }
        >
              ...
              {!isNaN(H_TQ_porcentaje) && (
                <React.Fragment>
                  <div className="medtarjeta_modal_item_medida">
                    ...
                    <div className="tarjeta_modal_item_value">
                      {H_TQ_porcentaje.toFixed(2)} %
                    </div>
                  </div>
                </React.Fragment>
              )}

...
const DialogTitle = withStyles(styles)((props) => {
    ...
    return (
        <MuiDialogTitle disableTypography className={classes.root} {...other}>
            ...
            {onClose ? (
                <IconButton aria-label="close" className={`${classes.closeButton} navButton`} onClick={onClose}>
                    <MdIcons.MdClose />
                </IconButton>
            ) : null}
        </MuiDialogTitle>
    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                <DialogTitle onClose={toggle} showSidebar={showSidebar} id="max-width-dialog-title">{info.nombre}</DialogTitle>
                ...
                {info.tipo === "perforacionAuto" && !mostrarPerfAuto && !mostrarTanque && (
                    <ModalList toggle={toggle} changeMostrarPerfAuto={changeMostrarPerfAuto} changeMostrarTanque={changeMostrarTanque} info={info} sectores={sectores} puntos={puntos} />
                )}
                ...
                {tipo !== "tanque" && info.tipo !== "perforacionAuto" && info.tipo !== "bomba" && (
                    <React.Fragment>

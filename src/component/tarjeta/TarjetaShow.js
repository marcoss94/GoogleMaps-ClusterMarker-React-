                    ...
                    <div className={`tarjeta_show_item ${listColor[0]}`}>
                        <div className={`tarjeta_show_item_left `}>
                            <div className="medtarjeta_show_item_medida">
                                ...
                                <div className='tarjeta_show_item_value'>{altura.toFixed(2)} mts</div>
                            ...
                            {!isNaN(porcentaje) && (
                                <React.Fragment>
                                    <div className="medtarjeta_show_item_medida">
                                        ...
                                        <div className='tarjeta_show_item_value'>{porcentaje.toFixed(2)} %</div>
                                    </div>
                                </React.Fragment>
                            )}
                        ...
                        <div className='tarjeta_show_item_right'>
                            ...
                            <div className={`tarjeta_show_item_icon icon_${listColor[0]}`}>
                                <img id="tarjeta_show_item__icono" alt="icono" src={defineIcons('tanque')} />
                            </div>
                        </div>
                ...
                {PUMP_PERF_STATE && (
                    <div className={`tarjeta_show_item ${listColor[1]}`} >
                        <div className='tarjeta_show_item_left'>
                            ...
                            <div className='tarjeta_show_item_value'>{PUMP_PERF_STATE === "ON" ? "ENCENDIDA" : "APAGADA"}</div>
                        </div>
                        <div className='tarjeta_show_item_right'>

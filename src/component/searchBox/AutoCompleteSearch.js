...
function AutoCompleteSearch(props) {
  ...
  return (
    <React.Fragment>
      <div
        className={`autoComplete ${rightBar ? "rightBar" : ""}`}
        id="autoComplete"
      >
        <div className="autoComplete__container">
          ...
          <FaIcons.FaSearch
            className="autoComplete__searchIcon"
            style={{ color: "#1B77C2" }}
          />
        </div>

        <div
          className={`autoComplete__suggestions ${visible ? "visible" : ""}`}
        >
